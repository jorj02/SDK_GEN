...
// Parameters:
// class USlotBaseWidget_C*       NewParam                       (Parm, ZeroConstructor, IsPlainOldData)

void UItemToolTipWidget_Gamepad_C::UpdateItemSlot(class USlotBaseWidget_C* NewParam)
{
	static auto fn = UObject::FindObject<UFunction>("Function ItemToolTipWidget_Gamepad.ItemToolTipWidget_Gamepad_C.UpdateItemSlot");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function ItemToolTipWidget_Gamepad.ItemToolTipWidget_Gamepad_C.OnInputY");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function ItemToolTipWidget_Gamepad.ItemToolTipWidget_Gamepad_C.OnInputA");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function ItemToolTipWidget_Gamepad.ItemToolTipWidget_Gamepad_C.On_InteractText_Prepass_1");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function ItemToolTipWidget_Gamepad.ItemToolTipWidget_Gamepad_C.OnPrepass_1");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function ItemToolTipWidget_Gamepad.ItemToolTipWidget_Gamepad_C.NewFunction_1");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function ItemToolTipWidget_Gamepad.ItemToolTipWidget_Gamepad_C.InputB");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function ItemToolTipWidget_Gamepad.ItemToolTipWidget_Gamepad_C.DisableAxis");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function ItemToolTipWidget_Gamepad.ItemToolTipWidget_Gamepad_C.DiableAction");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function ItemToolTipWidget_Gamepad.ItemToolTipWidget_Gamepad_C.SetupInput");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function ItemToolTipWidget_Gamepad.ItemToolTipWidget_Gamepad_C.InitWidget");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function ItemToolTipWidget_Gamepad.ItemToolTipWidget_Gamepad_C.Construct");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function ItemToolTipWidget_Gamepad.ItemToolTipWidget_Gamepad_C.ExecuteUbergraph_ItemToolTipWidget_Gamepad");
