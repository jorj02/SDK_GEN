...
{
	static auto fn = UObject::FindObject<UFunction>("Function NewMatchResultWidget.NewMatchResultWidget_C.OnPrepass_GamepadSpectaingButton");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function NewMatchResultWidget.NewMatchResultWidget_C.GetBackground_2");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function NewMatchResultWidget.NewMatchResultWidget_C.GetBackground_1");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function NewMatchResultWidget.NewMatchResultWidget_C.SwapHumanZombieBoxPosition");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function NewMatchResultWidget.NewMatchResultWidget_C.GetText_2");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function NewMatchResultWidget.NewMatchResultWidget_C.GetText_1");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function NewMatchResultWidget.NewMatchResultWidget_C.UpdateZombieGroup");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function NewMatchResultWidget.NewMatchResultWidget_C.UpdateHumanGroup");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function NewMatchResultWidget.NewMatchResultWidget_C.UpdateZombieModeMatchResult");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function NewMatchResultWidget.NewMatchResultWidget_C.Get_TextBlock_72_Text_1");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function NewMatchResultWidget.NewMatchResultWidget_C.Get_ButtonKillcam_ToolTipText_1");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function NewMatchResultWidget.NewMatchResultWidget_C.On_ButtonKillcam_Prepass_1");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function NewMatchResultWidget.NewMatchResultWidget_C.BndEvt__ButtonKillcam_K2Node_ComponentBoundEvent_31_OnButtonClickedEvent__DelegateSignature");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function NewMatchResultWidget.NewMatchResultWidget_C.OnSpectator");
