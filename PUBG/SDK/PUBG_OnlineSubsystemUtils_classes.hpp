...
{
public:
	unsigned char                                      LogPortUnreach : 1;                                       // 0x0420(0x0001) (Config)
	unsigned char                                      AllowPlayerPortUnreach : 1;                               // 0x0420(0x0001) (Config)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0421(0x0003) MISSED OFFSET
	uint32_t                                           MaxPortCountToTry;                                        // 0x0424(0x0004) (ZeroConstructor, Config, IsPlainOldData)
